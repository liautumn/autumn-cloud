...
public class ${entityName}ServiceImpl extends ServiceImpl<${entityName}Mapper, ${entityName}> implements ${entityName}Service {
     ...
     */
    @Override
    public Result select${entityName}(${entityName}SelectDto ${entityName?uncap_first}SelectDto) {
        Page<${entityName}> page = PageHelper.startPage(${entityName?uncap_first}SelectDto.getPageNum(), ${entityName?uncap_first}SelectDto.getPageSize());
        LambdaQueryWrapper<${entityName}> queryWrapper = new LambdaQueryWrapper<${entityName}>()
                .orderByDesc(${entityName}::getCreateTime);
        List<${entityName}> ${entityName?uncap_first}List = ${entityName?uncap_first}Mapper.selectList(queryWrapper);
        return ResData.setDataTotal(page, ${entityName?uncap_first}List);
    }
     ...
     */
    @Override
    public Result insert${entityName}(${entityName}InsertDto ${entityName?uncap_first}InsertDto) {
        ${entityName} ${entityName?uncap_first} = new ${entityName}();
        BeanUtils.copyProperties(${entityName?uncap_first}InsertDto, ${entityName?uncap_first});
        int i = ${entityName?uncap_first}Mapper.insert(${entityName?uncap_first});
     ...
     */
    @Override
    public Result update${entityName}(${entityName}UpdateDto ${entityName?uncap_first}UpdateDto) {
        ${entityName} ${entityName?uncap_first} = new ${entityName}();
        BeanUtils.copyProperties(${entityName?uncap_first}UpdateDto, ${entityName?uncap_first});
        int i = ${entityName?uncap_first}Mapper.updateById(${entityName?uncap_first});
        return i > 0 ? Result.success() : Result.fail();
    }
    ...
    public Result delete${entityName}(String ids) {
        ...
        int i = ${entityName?uncap_first}Mapper.deleteBatchIds(idList);
        return i > 0 ? Result.success() : Result.fail();
    }

...
INSERT INTO `config_info` VALUES (1,'sa-token-config.yml','DEFAULT_GROUP','# Sa-Token配置\r\nsa-token:\r\n  # token名称 (同时也是cookie名称)\r\n  token-name: autumn-token\r\n  # token有效期，单位s 默认30天, -1代表永不过期\r\n  timeout: 2592000\r\n  # token临时有效期 (指定时间内无操作就视为token过期) 单位: 秒\r\n  activity-timeout: -1\r\n  # 是否允许同一账号并发登录 (为true时允许一起登录, 为false时新登录挤掉旧登录)\r\n  is-concurrent: false\r\n  # 在多人登录同一账号时，是否共用一个token (为true时所有登录共用一个token, 为false时每次登录新建一个token)\r\n  is-share: false\r\n  # token风格\r\n  token-style: random-64\r\n  # 是否输出操作日志\r\n  is-log: false','e8cd1607884c1dd43486c71467b05fd0','2023-06-07 01:31:32','2023-06-07 01:31:32',NULL,'172.18.0.1','','dev',NULL,NULL,NULL,'yaml',NULL,''),(2,'redis-config.yml','DEFAULT_GROUP','spring:\n  # redis 配置\n  redis:\n    # 地址\n    host: 127.0.0.1\n    # 端口，默认为6379\n    port: 6379\n    # 数据库索引\n    database: 1\n    # 密码\n    password: zhuang2001\n    # 连接超时时间\n    timeout: 10s\n    lettuce:\n      pool:\n        # 连接池中的最小空闲连接\n        min-idle: 0\n        # 连接池中的最大空闲连接\n        max-idle: 8\n        # 连接池的最大数据库连接数\n        max-active: 8\n        # #连接池最大阻塞等待时间（使用负值表示没有限制）\n        max-wait: -1ms','969036755ad438cbadf88722c7c7db3e','2023-06-07 01:31:32','2023-06-07 02:53:30','nacos','172.18.0.1','','dev','','','','yaml','',''),(3,'autumn-system-dev.yml','DEFAULT_GROUP','spring:\n  # 数据库配置\n  datasource:\n    # 读写分离配置\n    #driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\n    #url: jdbc:shardingsphere:classpath:sharding-read-write.yaml\n    # 非读写分离配置\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/autumn_cloud?useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n    username: root\n    password: zhuang2001','bb41ad17bc2c7fe0704798ea64921c04','2023-06-07 01:31:32','2023-06-07 02:53:44','nacos','172.18.0.1','','dev','','','','yaml','',''),(4,'autumn-gateway-dev.yml','DEFAULT_GROUP','spring:\n  cloud:\n    gateway:\n      routes:\n        - id: auth_router\n          uri: lb://autumn-auth\n          predicates:\n            - Path=/auth/**\n        - id: system_router\n          uri: lb://autumn-system\n          predicates:\n            - Path=/system/**\n        - id: demo_router\n          uri: lb://autumn-demo\n          predicates:\n            - Path=/demo/**','8650d07478c44983965412e5ca9062c4','2023-06-07 01:31:32','2023-06-07 02:25:50','nacos','172.18.0.1','','dev','','','','yaml','',''),(5,'mybatis-plus-config.yml','DEFAULT_GROUP','#mybatis-plus配置\nmybatis-plus:\n  type-aliases-package: com.autumn.*.entity\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n    # 开启驼峰命名\n    map-underscore-to-camel-case: true\n  global-config:\n    db-config:\n      logic-delete-field: delFlag\n      logic-delete-value: 0\n      logic-not-delete-value: 1','1454394a59bba4a7ecad8dd272191122','2023-06-07 01:31:32','2023-06-07 02:50:48','nacos','172.18.0.1','','dev','','','','yaml','',''),(6,'autumn-demo-dev.yml','DEFAULT_GROUP','spring:\n  # 数据库配置\n  datasource:\n    # 读写分离配置\n    #driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\n    #url: jdbc:shardingsphere:classpath:sharding-read-write.yaml\n    # 非读写分离配置\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/autumn_cloud?useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n    username: root\n    password: zhuang2001','bb41ad17bc2c7fe0704798ea64921c04','2023-06-07 01:31:32','2023-06-07 02:53:58','nacos','172.18.0.1','','dev','','','','yaml','',''),(7,'global-config.yml','DEFAULT_GROUP','spring:\n  main:\n    #允许存在多个Feign调用相同Service的接口\n    allow-bean-definition-overriding: true\npagehelper:\n  helper-dialect: mysql\n# SpringBoot的日志级别默认为info,大于full,导致feign的日志配置不会输出，所以加以下配置\nlogging:\n  level:\n    com.dt.springcloud.openfeign: debug\n# feign日志全局配置\nfeign:\n  client:\n    config:\n      #想要调用的微服务名称(default全局)\n      default:\n        logger-level: BASIC\n        # 连接超时时间，默认2s\n        connectTimeout: 5000\n        # 请求处理超时时间，默认5s\n        readTimeout: 10000\n        request-interceptors: com.autumn.open_feign.FeignAuthRequestInterceptor\n    ','2a43f89acf2ffcbf3dcb01e7c86b5764','2023-06-07 01:31:32','2023-06-07 01:32:33','nacos','172.18.0.1','','dev','','','','yaml','',''),(8,'sharding-read-write.yaml','DEFAULT_GROUP','mode:\r\n  type: Standalone\r\n  repository:\r\n    type: JDBC\r\n\r\ndataSources:\r\n  master:\r\n    dataSourceClassName: com.zaxxer.hikari.HikariDataSource\r\n    driverClassName: com.mysql.cj.jdbc.Driver\r\n    jdbcUrl: jdbc:mysql://127.0.0.1:3307/test_db?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true\r\n    username: root\r\n    password: zhuang2001\r\n  slave1:\r\n    dataSourceClassName: com.zaxxer.hikari.HikariDataSource\r\n    driverClassName: com.mysql.cj.jdbc.Driver\r\n    jdbcUrl: jdbc:mysql://127.0.0.1:3308/test_db?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true\r\n    username: root\r\n    password: zhuang2001\r\n  slave2:\r\n    dataSourceClassName: com.zaxxer.hikari.HikariDataSource\r\n    driverClassName: com.mysql.cj.jdbc.Driver\r\n    jdbcUrl: jdbc:mysql://127.0.0.1:3309/test_db?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true\r\n    username: root\r\n    password: zhuang2001\r\n\r\nrules:\r\n- !READWRITE_SPLITTING\r\n  dataSources:\r\n    readwrite_ds:\r\n      staticStrategy:\r\n        # 写\r\n        writeDataSourceName: master\r\n        # 读\r\n        readDataSourceNames:\r\n          - slave1\r\n          - slave2\r\n      loadBalancerName: roundRobin\r\n  # 策略\r\n  loadBalancers:\r\n    roundRobin:\r\n      type: ROUND_ROBIN # 轮询\r\n\r\nprops:\r\n  sql-show: true','fae38621f427776bf0637269bfd5f1f5','2023-06-07 01:31:32','2023-06-07 01:31:32',NULL,'172.18.0.1','','dev',NULL,NULL,NULL,'yaml',NULL,''),(13,'autumn-auth-dev.yml','DEFAULT_GROUP','spring:\n  # 数据库配置\n  datasource:\n    # 读写分离配置\n    #driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\n    #url: jdbc:shardingsphere:classpath:sharding-read-write.yaml\n    # 非读写分离配置\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/autumn_cloud?useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n    username: root\n    password: zhuang2001\n  \nautumn:\n  password:\n    salt: kjsdafhjekhiohni','3f7166aaa8dbb8c8d230be61fe3a9982','2023-06-07 02:31:09','2023-06-07 02:53:10','nacos','172.18.0.1','','dev','','','','yaml','',''),(14,'autumn-generate-dev.yml','DEFAULT_GROUP','spring:\r\n  # 数据库配置\r\n  datasource:\r\n    # 读写分离配置\r\n    #driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\r\n    #url: jdbc:shardingsphere:classpath:sharding-read-write.yaml\r\n    # 非读写分离配置\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    url: jdbc:mysql://127.0.0.1:3306/autumn_cloud?useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\r\n    username: root\r\n    password: zhuang2001','b1ee192e864548bd8be6a7ddcda54227','2023-06-11 10:21:14','2023-06-11 10:21:14','nacos','172.18.0.1','','dev',NULL,NULL,NULL,'yaml',NULL,'');
...
-- Dump completed on 2023-06-11 20:24:55

package com.autumn.dictData.excel;
...
@Slf4j
public class DictDataDataListener implements ReadListener<DictData> {
     ...
     * 缓存的数据
     */
    private List<DictData> insertDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    private List<DictData> updateDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    /**
     ...
     * @param service
     */
    public DictDataDataListener(DictDataService service) {

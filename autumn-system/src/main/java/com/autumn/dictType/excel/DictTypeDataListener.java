package com.autumn.dictType.excel;
...
@Slf4j
public class DictTypeDataListener implements ReadListener<DictType> {
     ...
     * 缓存的数据
     */
    private List<DictType> insertDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    private List<DictType> updateDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    /**
     ...
     * @param service
     */
    public DictTypeDataListener(DictTypeService service) {
     ...
     */
    @Override
    public void invoke(DictType data, AnalysisContext context) {
